...
item_2 = 5
# 3. Создать переменную result_sum  котоой вы суммируете item_1 и item_2.
...
# 17. Создать переменную result_mp_s_root в которой вы найдёте квадратный корень любой из переменной item используя библиотеку math
#  используя метод pow.
...
print('делим item_1 на  item_2=',result_division)
...
print('ближайшее целое=',result_m_floor)
...
print('округляем до ближайшего большего целого=',result_m_ceil)
...
print('округлили до ближайшего целого result_division =',result_int)
...
print("без остатка=",result_no_division_loss)
...
print('вывод остатка=',result_division_loss)
